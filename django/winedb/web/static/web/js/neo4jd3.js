    ...
    function Neo4jD3(_selector, _options) {
        var container, graph, info, node, nodes, relationship, relationshipOutline, relationshipOverlay, relationshipText, relationships, selector, simulation, svg, svgNodes, svgRelationships, svgScale, svgTranslate,
            ...
            options = {
                ...
                nodeOutlineColor: undefined,
                nodeOutlineFillColor: undefined,
                nodeRadius: 25,
                relationshipColor: '#a5abb6',
                zoomFit: false
            },
            VERSION = '0.0.2'; // modified by Herman Dempere @nerucius
        ...
        function appendImageToNode(node) {
            return node.append('image')
                       .attr('height', function(d) {
                           return icon(d) ? '24px': '100px';
                       })
                       .attr('x', function(d) {
                           return icon(d) ? '5px': '-50px';
                       })
        ...
        function appendOutlineToNode(node) {
            return node.append('circle')
                       ...
                       .style('stroke', function(d) {
                           return options.nodeOutlineColor ? options.nodeOutlineColor : class2darkenColor(d.labels[0]);
                       })
